...
public class ProgressBar {
	 ...
	 public void SetProgressBar()
	 {
		 ...
		 {
			case 1:
				Global.progressBar = new ImageZone(screen1, 0, 0);
				break;
			case 2: 
				Global.progressBar = new ImageZone(screen2, 0, 0);
				break;
			case 3: 
				Global.progressBar = new ImageZone(screen3, 0, 0);
				break;
			case 4:
				Global.progressBar = new ImageZone(screen4, 0, 0);
				break;
		}
